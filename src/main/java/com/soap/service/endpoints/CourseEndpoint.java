...
import tutorial.soapservice.GetCourseResponse2;
...
public class CourseEndpoint {
    ...
    @PayloadRoot(namespace = NAMESPACE_URI, localPart = "getCourseRequest2")
    @ResponsePayload
    public GetCourseResponse2 getCourse2(@RequestPayload GetCourseRequest request){
        ObjectFactory objectFactory = new ObjectFactory();
        GetCourseResponse2 response = objectFactory.createGetCourseResponse2();
